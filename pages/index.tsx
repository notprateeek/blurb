...
const Home: NextPage = () => {
  ...
  } biographies with no hashtags and clearly labeled "1.", "2.", and "3.". Only return these 3 bios, nothing else. ${
    vibe === 'Funny' ? 'Make the biographies humerous' : ''
  }Make sure each generated biography is less than 300 characters, has short sentences that are found in bios, and feel free to use this context as well: ${bio}${
    bio.slice(-1) === '.' ? '' : '.'
  }`
    ...
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20">
        <p className="border rounded-2xl py-1 px-4 text-slate-500 text-sm mb-5 hover:scale-105 transition duration-300 ease-in-out">
          <b>Thousands</b> of bios generated so far
        </p>
        <h1 className="sm:text-6xl text-4xl max-w-[620px] font-bold text-slate-900">
